 ...
 */
public class CoapPostClientProcessLightBrightness {

	private final static Logger logger = LoggerFactory.getLogger(CoapPostClientProcessLightBrightness.class);
