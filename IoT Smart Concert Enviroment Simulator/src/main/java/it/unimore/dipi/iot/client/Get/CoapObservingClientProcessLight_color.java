 ...
 */
public class CoapObservingClientProcessLight_color {

    private final static Logger logger = LoggerFactory.getLogger(CoapObservingClientProcessLight_color.class);

    public static void main(String[] args) {

        String targetCoapResourceURL = "coap://127.0.0.1:5684/main_light/color";
        ...
        CoapObserveRelation relation = client.observe(request, new CoapHandler() {
            ...
            public void onLoad(CoapResponse response) {
                ...
                if ( response.isSuccess()){
                    ...
                    logger.error("INVALID COLOR CHOICE!! usage: white, blue, red, green");
                }
            }
