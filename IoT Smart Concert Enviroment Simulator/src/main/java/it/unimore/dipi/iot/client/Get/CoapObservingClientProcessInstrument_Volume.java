 ...
 */
public class CoapObservingClientProcessInstrument_Volume {

    private final static Logger logger = LoggerFactory.getLogger(CoapObservingClientProcessInstrument_Volume.class);

    public static void main(String[] args) {

        String targetCoapResourceURL = "coap://127.0.0.1:5684/keyboard/volume";
