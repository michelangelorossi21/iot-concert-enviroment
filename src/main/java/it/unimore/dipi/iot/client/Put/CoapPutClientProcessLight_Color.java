 ...
 */
public class CoapPutClientProcessLight_Color {

	private final static Logger logger = LoggerFactory.getLogger(CoapPutClientProcessLight_Color.class);

	private static final String COAP_ENDPOINT = "coap://127.0.0.1:5684/main_light/color";
