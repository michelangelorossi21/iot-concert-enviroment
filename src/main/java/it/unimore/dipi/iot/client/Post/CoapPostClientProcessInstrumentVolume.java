 ...
 */
public class CoapPostClientProcessInstrumentVolume {

	private final static Logger logger = LoggerFactory.getLogger(CoapPostClientProcessInstrumentVolume.class);

	private static final String COAP_ENDPOINT = "coap://127.0.0.1:5684/main_light/brightness";
