 ...
 */
public class CoapObservingClientProcessLight_temperature {

    private final static Logger logger = LoggerFactory.getLogger(CoapObservingClientProcessLight_temperature.class);

    public static void main(String[] args) {

        String targetCoapResourceURL = "coap://127.0.0.1:5684/main_light/temperature";
