 ...
 */
public class CoapObservingClientProcessInstrument_Acoustic {

    private final static Logger logger = LoggerFactory.getLogger(CoapObservingClientProcessInstrument_Acoustic.class);

    public static void main(String[] args) {

        String targetCoapResourceURL = "coap://127.0.0.1:5684/keyboard/acoustic";
