 ...
 */
public class CoapPutClientProcessInstrument_Volume {

	private final static Logger logger = LoggerFactory.getLogger(CoapPutClientProcessInstrument_Volume.class);

	//private static final String COAP_ENDPOINT = "coap://127.0.0.1:5684/instrument/volume";
