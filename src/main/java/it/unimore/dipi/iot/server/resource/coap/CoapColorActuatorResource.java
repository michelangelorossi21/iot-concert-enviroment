 ...
 */
public class CoapColorActuatorResource extends CoapResource {

    private final static Logger logger = LoggerFactory.getLogger(CoapColorActuatorResource.class);
    ...
    private ColorChangerRawActuator colorChangerRawActuator;

    private String color = WHITE_COLOR;

    private String deviceId;

    public CoapColorActuatorResource(String deviceId, String name, ColorChangerRawActuator colorChangerRawActuator) {
        super(name);

        if(colorChangerRawActuator != null && deviceId != null){

            this.deviceId = deviceId;

            this.colorChangerRawActuator = colorChangerRawActuator;
            ...
            getAttributes().addAttribute("rt", colorChangerRawActuator.getType());
            getAttributes().addAttribute("if", CoreInterfaces.CORE_A.getValue());
            getAttributes().addAttribute("ct", Integer.toString(MediaTypeRegistry.APPLICATION_SENML_JSON));
            getAttributes().addAttribute("ct", Integer.toString(MediaTypeRegistry.TEXT_PLAIN));

            colorChangerRawActuator.addDataListener(new ResourceDataListener<String>() {
                @Override
    ...
    public void handleGET(CoapExchange exchange) {
        ...
        //Otherwise respond with the default textplain payload
            ...
            exchange.respond(CoAP.ResponseCode.CONTENT, String.valueOf(color), MediaTypeRegistry.TEXT_PLAIN);
    ...
    public void handlePOST(CoapExchange exchange) {
        ...
        try{
            ...
            if(exchange.getRequestPayload() == null){
                ...
                this.colorChangerRawActuator.incrementColor();

                logger.info("Resource Status Updated: {}", this.colorChangerRawActuator.getColor());
    ...
    public void handlePUT(CoapExchange exchange) {
        ...
        try{
            ...
            if(exchange.getRequestPayload() != null){
                ...
                //Update internal status
                if (this.colorChangerRawActuator.getColorsList().contains(submittedValue)){
                    this.color = submittedValue;
                    this.colorChangerRawActuator.setColor(this.color);

                    logger.info("Resource Status Updated: {}", this.color);
